...
$(document).ready(function () {
  ...
  $(".swiper-slide .join-action").on("click", function () {
    ...
    if (tmp != 0) {
      ...
      $(".discount-text").html(
        '<p class="pre-text">Вы решили купить Kugoo без скидки или подарка :(</p>'
      );
    }
  });
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        if (aa.indexOf("1203") + 1) {
          $(".answer").html(
            "<h4>Поздравляем, ваш Kugoo подлинный!</h4><p>Произведен: Март, 2019 года</p>"
          );
          $(".prov-form").trigger("reset");
        } else if (aa.indexOf("1506") + 1) {
          $(".answer").html(
            "<h4>Поздравляем, ваш Kugoo подлинный!</h4><p>Произведен: Июль, 2019 года</p>"
          );
          $(".prov-form").trigger("reset");
        } else {
          $(".answer").html(
            "<h4>Что-то не так, серийного номера <br> <span>" +
              aa +
              "</span> нет в базе</h4>"
          );
          $(".prov-form").trigger("reset");
      ...
      beforeOpen: function () {
        ...
        (function () {
          ...
          hcc.src =
            ...
            "://w.hypercomments.com/widget/hc/104125/" +
            lang +
            "/widget.js";
